...
styled(Icon$m)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var Spinner = function (_a) {
    ...
    return (React.createElement(Container$3, null,
        React.createElement("img", { src: img, width: "".concat(size, "px") })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Jet home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Jet home page" }, innerLogo))));
};
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Liquidity",
                href: "https://swap.moonwalker.network/#/pool",
            },
        ],
    },
    {
...
var SolarPrice = function (_a) {
    var solarPriceUsd = _a.solarPriceUsd;
    return solarPriceUsd ? (React.createElement(PriceLink, { href: "https://snowtrace.io/address/0x5ce9680bddc91d955a51b959f5cabaf466b0be5a", target: "_blank" },
        React.createElement(Icon$p, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$".concat(solarPriceUsd.toFixed(3))))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var SolarPrice$1 = React.memo(SolarPrice);
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, solarPriceUsd = _a.solarPriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang;
    if (!isPushed) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            React.createElement(SolarPrice$1, { solarPriceUsd: solarPriceUsd }),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.moonwalker.network/faq", external: true },
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://snowtrace.io/address/".concat(account), mr: "16px" }, "View on BscScan"),
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, solarPriceUsd = _a.solarPriceUsd, links = _a.links, children = _a.children;
    ...
    return (React.createElement(Wrapper, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, solarPriceUsd: solarPriceUsd, pushNav: setIsPushed, links: links }),
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#f51909", background: "#2B2B2B", backgroundDisabled: "#C7C7C7", contrast: "#FFFFFF", invertedContrast: "#343434", input: "#444444", inputSecondary: "#444444", primaryDark: "#f51909", tertiary: "#444444", text: "#FFFFFF", textDisabled: "#777777", textSubtle: "#FFFFFF", borderColor: "#C7C7C7", card: "#343434", extra: "#FAC504", button: "linear-gradient(90deg, #f51909 0%, #7C6A25 100%)", farming: 'rgba(255, 255, 255, 0.1)', gradients: {
